 ...
 *
 * The `Credentials` data class encapsulates the `DittoIdentity` object
...
data class Credentials(
    ...
    /**
     * The token used to authenticate with the authentication service.
     *
