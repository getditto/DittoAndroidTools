package com.ditto.tools.health.ui.composables
...
import com.ditto.tools.health.HealthScreenActionHandler
import com.ditto.tools.health.HealthUiActionType
import com.ditto.tools.health.HealthUiStateCause
import com.ditto.tools.health.components.HealthCheckWithAction
import com.ditto.tools.health.components.HealthCheckWithNoAction
import com.ditto.tools.health.components.Loading
import com.ditto.tools.health.data.HealthUiState
import com.ditto.tools.health.data.DeviceDetails
import com.ditto.tools.health.ui.viewmodel.HealthViewModel
...
internal fun TransportHealthInformation(
    ...
    TransportHealthInformation(
        modifier = modifier,
        state = state,
        onAction = { actionType: HealthUiActionType ->
