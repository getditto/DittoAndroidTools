...
class PresenceFlowUseCase(
    ...
    private fun resolveTransportInfo(peer: DittoPeer): PeerTransportInfo {
        ...
        val lanConnections = countLanConnections(connections)
...
internal fun countLanConnections(connectionTypes: Iterable<DittoConnectionType>): Int =
    connectionTypes.count { it == DittoConnectionType.AccessPoint }
